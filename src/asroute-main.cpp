...
{ QCoreApplication::setOrganizationName ("BerndStramm");
  ...
  navi::AsRoute   asroute;

  app.setWindowIcon (asroute.windowIcon());
  asroute.Init (app);
  asroute.AddConfigMessages (configMessages);
